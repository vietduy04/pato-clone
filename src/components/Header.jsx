...
const NAV_LINKS = [
  ...
  { label: 'Đề án cung cấp dịch vụ TMĐT', to: '/pages/de-an-cung-cap-dich-vu-thuong-mai-dien-tu' },
]
  ...
  function handleQueryChange(val) {
    ...
    debounceRef.current = setTimeout(() => {
      ...
      const results = restaurants
        .filter(r => r.title.toLowerCase().includes(q) || r.address.toLowerCase().includes(q))
        .slice(0, 8)
    ...
    <>
      ...
      <div className={`nav-drawer ${mobileNavOpen ? 'open' : ''}`}>
        ...
        <ul className="mobile-nav">
          <li><a href="tel:19002280">📞 Hotline: 1900.2280</a></li>
          {NAV_LINKS.map(l => (
            <li key={l.to}>
              <Link to={l.to} onClick={() => setMobileNavOpen(false)}>{l.label}</Link>
            </li>
          ))}
        </ul>
      </div>
              ...
              <div className="header-top-inner">
                ...
                <div className="header-logo-search">
                  <div className="header-logo">
                    <Link to="/">
                      <img src="/images/logo.png" alt="PATO - Kênh thông tin và đặt bàn Nhà hàng" />
                    </Link>
                  </div>
                    ...
                    <form onSubmit={handleSearch} className="header-search-form">
                      <div className="search-input-wrap">
                        ...
                        <button type="submit" className="search-btn">
                          <svg width="16" viewBox="0 0 53.627 53.627" fill="currentColor">
                        ...
                        {suggestions.map(r => (
                          ...
                          >
                            ...
                            <div className="suggestion-title">
                              {r.title}
                              {r.status === 'Đã hợp tác' && <span className="star-icon">⭐</span>}
                            </div>
                          </Link>
                        ))}
                      </div>
              ...
              <nav className="header-navbar">
                <ul>
                  {NAV_LINKS.map(l => (
                    <li key={l.to}>
                      <Link to={l.to}>
                        <div className="hd-link-title">{l.label}</div>
                      </Link>
                    </li>
                  ))}
                </ul>
        ...
        <div className="header-mobile">
          <div className="wrapper">
            <div className="header-mobile-inner">
              <button className="hd-btnMenu" onClick={() => setMobileNavOpen(true)}>
              ...
              <div className="hd-logo">
                <Link to="/">
                  <img src="/images/logo.png" alt="PATO" />
                </Link>
              </div>
              <button className="search-mb-btn" onClick={() => setMobileSearchOpen(v => !v)}>
